import { Mail, PackageCheck, Ruler, RotateCcw, Truck } from "lucide-react";
    ...
    <main id="content" className="inner-page support-page">
      ...
      <div className="support-content">
        ...
        <section id="delivery" className="support-section">
          <div className="support-section-title"><Truck size={24} strokeWidth={1.25} /><p className="eyebrow dark">02 / DELIVERY & RETURNS</p><h2>배송과 반품 안내</h2></div>
        ...
        <section id="size-guide" className="support-section">
          <div className="support-section-title"><Ruler size={24} strokeWidth={1.25} /><p className="eyebrow dark">03 / SIZE GUIDE</p><h2>사이즈 가이드</h2></div>
